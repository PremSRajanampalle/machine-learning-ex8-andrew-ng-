...
for epsilon = min(pval):stepsize:max(pval)
    ...
    #tp = (yval == 1) & (pval < epsilon); # Actual value is 1 and predicted values is also 1
    #fp = (yval == 0) & (pval < epsilon); # Actual value is not 1 but predicted as 1
    #fn = (yval == 1) & (pval >= epsilon);# Actual value is 1 but predicted as not 1
